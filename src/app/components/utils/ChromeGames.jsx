...
"use client"
// https://github.com/SagarKhengat/react-native-offline-game?tab=readme-ov-file
// to be convert
...
export default class ChromeDinoGame extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <canvas id="canvas" ref={ref => this.canvas = ref} height={110} width={340} />
        );
    }
};